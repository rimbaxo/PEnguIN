...
const SuccesScreenABC = ({ navigation }: { navigation: NavigationProp<RootStackParamList> }) => {
    ...
    <View style={styles.mainView}>
      <View style={styles.secondView}>
        <View style={styles.textContainer}>
          ...
          <View style={styles.infoContainer}>
            ...
            <Text style={[styles.textInfo, styles.exercise]}>Diario ABC Cognitivo</Text>
          </View>
      ...
      <AnimatedNative.View style={[animatedStyle, styles.button]}>
        <ButtonSubmit
          ...
          text="Procedi"
          onPress={() => navigation.navigate('ABCCognitive')}
...
export default SuccesScreenABC;
