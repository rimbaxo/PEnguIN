...
const SuccesScreen = ({ navigation }: { navigation: NavigationProp<RootStackParamList> }) => {
    ...
    <View style={styles.mainView}>
      <View style={styles.secondView}>
        <View style={styles.textContainer}>
          ...
          <View style={styles.infoContainer}>
            ...
            <Text style={[styles.textInfo, styles.exercise]}>Ruota delle Emozioni</Text>
          </View>
      ...
      <AnimatedNative.View style={[animatedStyle, styles.button]}>
        <ButtonSubmit
          ...
          text="Procedi"
          onPress={() => navigation.navigate('EmotionExercises')}
