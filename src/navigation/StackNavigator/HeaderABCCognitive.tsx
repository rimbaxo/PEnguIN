...
const HeaderABCCognitive: FC<HeaderProps> = (props) => {
        ...
        <View style={styles.header}>
            <Appbar style={styles.container}>
                <View style={styles.barNav}>
                    <ButtonIcon icon="ArrowLeft" onPress={showDialog} color={`rgba(255, 255, 255, 0.1)`} iconColor={theme.colors.background}/>
...
HeaderABCCognitive.defaultProps = {
...
export default HeaderABCCognitive;